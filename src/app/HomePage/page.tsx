  ...
  return (
    <>
      <section className='bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row md:items-center py-[50px]'>
        {/* Heading */}
        <div className='text-white w-full md:w-[50%] mt-20'>
      ...
      <section className="bg-black px-3 md:px-[135px] flex flex-col justify-evenly md:flex-row md:items-center py-[50px]">
        ...
        <div className="mt-[50px] md:mt-0 ">
          <Image src={foodpic1} alt="Hero Image" width={336} height={500} className="rounded-lg mb-4" />
          
          <div className="flex space-x-4">
            <Image src={foodpic2} alt="Food Pic 2" width={160} height={300} className="rounded-lg" />
            <Image src={foodpic3} alt="Food Pic 3" width={160} height={300} className="rounded-lg" />
          </div>
        </div>
      </section>
